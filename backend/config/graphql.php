...
return [
    ...
    'context' => \App\GraphQL\GraphContext::class,
    'batching' => [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'example' => \App\GraphQL\Queries\ExampleQuery::class
            ],
            'mutation' => [
            ...
            // 'middleware' => [
            //     \App\GraphQL\Middleware\DynamicAuthMiddleware::class,
            // ],
        ...
        'public' => [
            'query' => [
                'postById' => \App\GraphQL\Queries\PostById::class,
                'getPosts' => \App\GraphQL\Queries\Post::class,
            ],
            'types' => [
                'Post' => \App\GraphQL\Types\PostType::class,
                'Media' => \App\GraphQL\Types\MediaType::class,
                'Comment' => \App\GraphQL\Types\CommentType::class,
                'Like' => \App\GraphQL\Types\LikeType::class,
                'MediaInput' => \App\GraphQL\Types\MediaInputType::class,
                'Upload' => \Rebing\GraphQL\Support\UploadType::class,
        ...
        'user' => [
            ...
            'mutation' => [
                ...
                'logout' => \App\GraphQL\Mutations\Logout::class,
                'register' => \App\GraphQL\Mutations\Register::class,
            ],
            'middleware' => null, // or null
            'method' => ['GET', 'POST'],
        ],
        'post' => [
            'query' => [
                // 'getPosts' => \App\GraphQL\Queries\Post::class,
                'likeCount' => \App\GraphQL\Queries\LikeCount::class,
                // 'postById' => \App\GraphQL\Queries\PostById::class
            ],
            'types' => [
                'Post' => \App\GraphQL\Types\PostType::class,
            ...
            'mutation' => [
                'createPost' => \App\GraphQL\Mutations\CreatePost::class,
                'createComment' => \App\GraphQL\Mutations\CommentPost::class,
                'likePost' => \App\GraphQL\Mutations\LikePost::class,
            ],
            'middleware' => [
                'auth:api',
                // \App\GraphQL\Middleware\DynamicAuthMiddleware::class,
    ...
    //
    'types' => [
        \App\GraphQL\Types\ExampleType::class,
